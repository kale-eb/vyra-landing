      ...
      <div className="mx-auto max-w-4xl rounded-3xl border border-[#deded7] bg-[#f0f1eb] px-4 py-8 sm:px-8">
        ...
        <div className="mt-5 text-center">
          <a href="https://app.usevyra.com/signup" onClick={() => trackLead("Creator Case Study CTA")}
            className="inline-flex rounded-full bg-[#252d21] px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-[#3c4835] focus-visible:outline-2 focus-visible:outline-offset-4">
