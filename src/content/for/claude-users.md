...
description: >-
  Vyra connects to Claude through MCP so the Claude subscription you already pay
  for can see your footage, cut it, caption it, and build motion graphics from
  the same chat you use for everything...
updated: '2026-09-23'
category: for
---
