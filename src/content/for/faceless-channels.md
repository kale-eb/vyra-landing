...
- [Faceless narrated videos](/formats/faceless-video)
- [Explainers](/formats/explainer)
- [Tutorials](/formats/tutorial) and [app walkthroughs](/formats/app-walkthrough)
- [B-roll montages](/formats/montage) under music
...
1. Record narration, one file per video. Upload it with your b-roll or screen recording.
2. Describe the structure. What plays under which part, caption style, music or none.
3. Review the cut. Fix one thing per message. "Swap the clip at 0:14 for the drone shot."
4. Lock the style and describe the next video as "same style."
5. Export 9:16 for Shorts and TikTok, 16:9 for YouTube, from the same edit.
...
**Do I need to record narration first?**
It works best that way. The narration sets the timing. You can also start from footage and add voiceover later.

**Can it use stock footage I already licensed?**
Yes. Upload it like any other clip.

**Can I make a 10-minute YouTube video, not just Shorts?**
Yes. Describe the sections and it builds the long cut. Then ask for three Shorts from the strongest moments.
