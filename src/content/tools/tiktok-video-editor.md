...
category: tools
facts:
  - "Best for: Talking head, UGC, relatable, storytelling, and montage TikToks from real footage"
  - "Input: Phone or camera footage, any aspect ratio"
  - "Output: 9:16 MP4, Instagram/TikTok preset at 1080p and 20 Mbps, or up to 4K"
...
```
Make a 30-second TikTok from these clips. Open on the shot where I pull the canvas out of the box, then the three best painting moments. Cut all talking except the line "this is the part everyone skips". White 3-word captions, calm piano underneath at low volume.
```

```
Match the pacing and caption style of the attached reference TikTok. Use my footage only.
```

```
Remove every zoom and transition you added. Straight cuts only.
```
...
- /tools/instagram-reels-editor
- /tools/youtube-shorts-maker
