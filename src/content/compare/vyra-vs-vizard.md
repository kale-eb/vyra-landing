...
| | Vizard | Vyra |
| --- | --- | --- |
| Edits your real footage | Clips it | Yes, agent-driven |
| Edit by chat / natural language | Partial, prompts for clip selection; edits are transcript and timeline based | Yes, full edit by chat |
| Bring your own AI (MCP: Claude, ChatGPT, Cursor) | No | Yes, agent gets the full editing toolset |
| Understands footage (transcript + scene analysis) | Transcript-led highlight scoring | Transcript plus every scene described |
| Captions | Yes, templates | Yes, word-by-word or phrases |
| Beat sync | No | Yes |
| Motion graphics | Templates | Custom, built from a prompt |
| Reference style matching | No | Yes |
| Manual timeline | Light editor | Yes, full editor |
| Export cap | Depends on plan; see site | 1440p (AI Starter), 4K (AI Pro) |
| Best for | Clipping talks and podcasts at volume | AI-edited real footage from a brief |
...
- You have a long back catalog of talks and want clips with minimal effort.
- Clipping is the only editing you do.
- You like a scored list to choose from.
...
In Vyra:
```
From this 50-minute podcast, find five moments of 30-45 seconds where a complete point is made and the speaker is not interrupted. Prefer moments with a clear claim in the first sentence. Make each a 9:16 clip that follows the active speaker, phrase captions, bold white, and a two-word title at the top for the first 2 seconds. Tell me why you picked each one.
```
