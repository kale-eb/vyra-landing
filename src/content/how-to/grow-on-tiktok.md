...
```
Make three versions of this video that differ only in the first 3 seconds: one that opens on the reveal shot, one on the question I ask at 0:42, one on the line "I almost quit." Same edit after that.
```

```
This is a reply to a comment. Put the comment screenshot in the top third for the first 3 seconds, then cut to me answering. Keep it under 20 seconds.
```
...
- /how-to/cross-post-without-watermark
