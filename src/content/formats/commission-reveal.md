...
> Build a 30-second commission reveal. Start with the reference photo and the caption "she asked for her grandmother's garden" for 3 seconds. Then four process clips, cropped so the whole painting never shows, 2-3 seconds each on the beat. Then the signing clip. End on the tilt-up reveal with no cuts, hold the finished piece for 5 seconds, and add "longing, 28 x 37 in, acrylic and oil" in the lower third.

> Keep the music low until the reveal, then bring it up on the tilt.

> Crop the second process clip tighter so the top half of the canvas is hidden.
