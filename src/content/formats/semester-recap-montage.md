...
> Make a 35-second recap from these 14 painting clips, cut to the attached song. Chronological order, one painting per beat in the verse, two per beat in the chorus. Hold the "longing" clip for 3 seconds right before the drop. Open with the title "one semester, 14 paintings" for 2 seconds. End on the clip of me holding the last piece.

> Match the exposure across all 14 clips so the wall looks the same in each.

> Swap the order so the strongest piece is last, and put the two process clips in the quiet part before the chorus.
...
- [Sketchbook flip-through](/formats/sketchbook-flip-through)
