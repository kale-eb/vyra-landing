...
Minimal:
```
Make a 45-second highlight reel of this trip in chronological order.
```

Standard:
```
Build a 45-second 9:16 travel recap from these clips. Chronological, three days. Each day gets one establishing shot of where we are, two or three quick moments, and one peak held longer. Cut all talking except the clip where I say "we made it." Sync to the uploaded track, one cut every two beats, and let the peaks run for a full bar.
```
