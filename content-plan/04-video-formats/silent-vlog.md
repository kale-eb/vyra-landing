...
> Build a 75-second silent vlog from today's clips. Long cuts, 3-5 seconds each, no talking, keep the room sound and add a very quiet lo-fi track under it. Put short lowercase text like "slow morning" and "back to the studio" at the start of each section, on screen for 3 seconds. Soft warm grade. End on the shot of the empty desk.

> Remove any clip with camera shake and keep the rest in the order they were filmed.
