...
> Cut these outfit clips to the attached sound, one cut per beat, and put a quick zoom-in instead of a cut on the loudest beats. Slow down the spin clip on the pause before the drop, then cut on half-beats after the drop. End on the last hit with a hard cut to black. No captions.

> Add a white flash on the first beat of the drop and match the transition style of the attached reference.
