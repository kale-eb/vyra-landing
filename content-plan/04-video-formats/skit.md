...
> This is a two-character skit, I play both. Character A is the takes where I'm wearing the cap, character B is the takes without it. Cut the dialogue back and forth using the script order in my notes, tight with no pauses, and add captions colored blue for A and yellow for B. Add a short sound sting on the last line and end right after.

> Insert the reaction take of character B after A's line "that's not a real job".
