---
slug: /prompts/how-to-prompt-vyra
title: How to prompt an AI video editor (Vyra prompting 101)
summary: A good Vyra prompt states the target (length, platform, purpose), what to keep and cut, how captions and music should behave, and whether to follow a reference. Descriptive beats technical.
level: beginner
reading_time: 6 min
---
